...
## Motivation
A standard URL protocol for requesting native SOL and SPL Token transfers allows for a better user experience across wallets and apps in the Fyfy ecosystem.
...
Mobile wallets should ideally register to handle the URL scheme and provide a seamless yet secure experience when Fyfy Pay URLs are encountered in the environment.
...
[An actual example of such a proposal.](https://github.com/vamise/fyfy-pay/blob/master/SPEC.md#memoissues/26)
